export default function TransferredDataDisplay() {
    return (
        <div className="bg-white p-6 rounded-lg shadow-md w-auto m-5">
            <h2 className="text-lg font-semibold mb-4 text-gray-700">チェック条件</h2>

            <div className="flex gap-6 mb-6">

                <div className="border border-black p-2 rounded-lg basis-2/5 gap-6 flex items-center">
                ...
                <div className="border border-black p-4 rounded-lg basis-2/5">
                    <div className="flex items-center space-x-4 mb-4">
                        ...
                        <label className="inline-flex items-center">
                            ...
                            <span
                                className="ml-2 text-gray-700 whitespace-nowrap">操業日</span>
                        </label>
                        <label className="inline-flex items-center">
                            <input type="radio" name="date_type" value="data_sent_date"
                                   className="form-radio text-blue-600 rounded-full"/>
                            <span
                                className="ml-2 text-gray-700 whitespace-nowrap">データ送信日</span>
                        </label>
                        <label className="inline-flex items-center">
                            <input type="radio" name="date_type" value="data_registered_date"
                                   className="form-radio text-blue-600 rounded-full"/>
                            <span
                                className="ml-2 text-gray-700 whitespace-nowrap">データ登録日</span>
                        </label>
                    </div>
                    <div className="flex items-center space-x-2">
                        <input type="date"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div className="md:col-span-1 border border-gray-200 p-4 rounded-lg">
                    <h3 className="font-medium mb-3 text-gray-700">対象許可船</h3>
                    <div className="flex items-center space-x-4 mb-3">
                        <label className="inline-flex items-center">
                            <input type="radio" name="ship_target" value="specified"
                                   className="form-radio text-blue-600 rounded-full"/>
                            <span
                                className="ml-2 text-gray-700 whitespace-nowrap">対象船指定</span>
                        </label>
                        <label className="inline-flex items-center">
                            <input type="radio" name="ship_target" value="all"
                                   className="form-radio text-blue-600 rounded-full"/>
                            <span className="ml-2 text-gray-700 whitespace-nowrap">全船</span>
                        </label>
                    </div>
                    <div className="overflow-y-auto border border-gray-300 rounded-md max-h-40">
                ...
                <div className="md:col-span-1 border border-gray-200 p-4 rounded-lg">
                    <h3 className="font-medium mb-3 text-gray-700">出力対象</h3>
                    <div className="space-y-2">
                        <label className="inline-flex items-center">
                            <input type="checkbox" className="form-checkbox text-blue-600 rounded"/>
                            <span
                                className="ml-2 text-gray-700 whitespace-nowrap">転載量</span>
                        </label>
                        <label className="inline-flex items-center">
                            <input type="checkbox" className="form-checkbox text-blue-600 rounded"/>
                            <span className="ml-2 text-gray-700 whitespace-nowrap">相手船のみ</span>
                        </label>
                        <label className="inline-flex items-center">
                            <input type="checkbox" className="form-checkbox text-blue-600 rounded"/>
                            <span
                                className="ml-2 text-gray-700 whitespace-nowrap">累計のみ</span>
                        </label>
                    </div>
                </div>

                <div className="md:col-span-1 border border-gray-200 p-4 rounded-lg">
                    <h3 className="font-medium mb-3 text-gray-700">転載量警告範囲</h3>
                    <div className="space-y-2">
                        <div className="flex items-center space-x-2">
                            <div className="w-10 h-6 bg-yellow-300 rounded-md flex items-center justify-center"></div>
                            <input type="text" value="90"
                                   className="w-16 border border-gray-300 rounded-md p-1 text-center focus:ring-blue-500 focus:border-blue-500"/>
            ...
            <div className="flex justify-end items-center mb-6">
                <label className="inline-flex items-center">
                    <input type="checkbox" className="form-checkbox text-blue-600 rounded"/>
                    <span className="ml-2 text-gray-700 whitespace-nowrap">同上表示</span>
                </label>
            </div>
